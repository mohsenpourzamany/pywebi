            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                <div className="navbar-nav py-0">
                    ...
                    <div className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu m-0">
                            <Link to="priceplan" className="dropdown-item">Pricing Plan</Link>
                            <Link to="features" className="dropdown-item">Our features</Link>
                            <Link to="team" className="dropdown-item">Team Members</Link>
                            <Link to="testmonial" className="dropdown-item">Testimonial</Link>
                            <Link to="qoute" className="dropdown-item">Free Quote</Link>
                        </div>
                    </div>
